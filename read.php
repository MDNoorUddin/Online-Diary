...
<?php
 ...
 if(isset($_GET['id'])){
     ...
     {
         header("Location:updatenote.php?title=$title&date=$date&id=$id");
     }
     ...
     echo '<form action="" method="post">';
      while($row = mysqli_fetch_array($result)) {
          ...
          echo '<textarea style="width:800px;position:absolute;top:200px;left:200px;height:300px;" readonly class="form-control" rows="5">'.$row['paragraph'].'';
}
echo '</textarea>';
