...
?>
 ...
 <?php
 echo '<label for="name" style="position:absolute;top:200px;left:200px;"><b>Title</b></label>';
echo '<textarea  style="width:800px;position:absolute;top:230px;left:200px;" name="title">'.$row['title'].'
</textarea>';
echo '<label for="name" style="position:absolute;top:290px;left:200px;"><b>Note</b></label>';
echo '<textarea  style="width:800px;position:absolute;top:320px;left:200px;height:300px;" name="txt">'.$row['paragraph'].'
</textarea>';
...
style="position:absolute;top:630px;left:750px;">Delete </button>
<button type="submit"  class="btn btn-danger" onclick="return confirm('Are you sure to change this update?');" name="submit"
style="position:absolute;top:630px;left:900px;">Update </button>
